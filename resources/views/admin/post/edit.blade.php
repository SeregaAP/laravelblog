...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Редактировать статью: {{ $post['title']}}</h1>
                </div><!-- /.col -->
            </div><!-- /.row -->
            @if(session('success'))
                        ...
                        <form action="{{ route('post.update',$post['id']) }}" method="post">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $post['title'] }}" name="title" class="form-control" id="exampleInputEmail1" required placeholder="Введите название статьй">
                                </div>
                                <div class="form-group">
                                    <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" value="{{ $post['img'] }}" type="text" id="feature_image" name="img" value="" readonly>
